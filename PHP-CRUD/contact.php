    ...
    <body>
                ...
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        <div class="page-heading">
                            <h1 style="font-family: shareb;">تواصل معنا</h1>
                            <span class="subheading" style="font-family: shareb;">جواب سؤالكم عندنا  .</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <main class="mb-4">
            <div class="container px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        <p>هل ترغب في التواصل؟ قم بملء النموذج أدناه لإرسال رسالة إلي وسأقوم بالرد عليك في أقرب وقت ممكن  !</p>
                        <div class="my-5">
                            <!-- * * * * * * * * * * * * * * *-->
                            ...
                            <form id="contactForm" data-sb-form-api-token="API_TOKEN">
                                <div class="form-floating">
                                    ...
                                    <div class="invalid-feedback" data-sb-feedback="name:required">رجاء أكتب الإسم</div>
                                </div>
                                <div class="form-floating">
                                    <input class="form-control" id="email" type="email" placeholder="Enter your email..." data-sb-validations="required,email" />
                                    <label for="email">البريد الإلكتروني</label>
                                    <div class="invalid-feedback" data-sb-feedback="email:required">رجاء أكتب البريد الإلكتروني</div>
                                    <div class="invalid-feedback" data-sb-feedback="email:email">بريد إلكتروني غير مقبول</div>
                                </div>
                                <div class="form-floating">
                                    <input class="form-control" id="phone" type="tel" placeholder="Enter your phone number..." data-sb-validations="required" />
                                    <label for="phone">رقم الهاتف</label>
                                    <div class="invalid-feedback" data-sb-feedback="phone:required">رجاء أكتب رقم الهاتف</div>
                                </div>
                                <div class="form-floating">
                                    <textarea class="form-control" id="message" placeholder="Enter your message here..." style="height: 12rem" data-sb-validations="required"></textarea>
                                    <label for="message">رسالتكم</label>
                                    <div class="invalid-feedback" data-sb-feedback="message:required">رجاء أكتب رسالتكم</div>
                                </div>
                                <br />
                                ...
                                <!-- Submit Button-->
                                <!-- <button class="btn btn-primary text-uppercase " id="submitButton" type="submit">Send</button> id="submitButton"-->
                                <button class="btn btn-primary text-uppercase " id="submitButton" type="submit"  href="moubarakelkouchi61@gmail.com" target="_blank">Send</button>
