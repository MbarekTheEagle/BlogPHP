                ...
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        <div class="site-heading">
                            <h1 style="font-family: shareb;">مدونة الأنامل</h1>
                ...
                <div class="col-md-10 col-lg-8 col-xl-7">
                                ...
                                ?>
                                  <!--Boostrap div card
                                    <div class="card" style="width: 18rem;">
                                        <img class="card-img-top" src="assets\img\pdmisc1-16-nap.jpg" alt="Card image cap">
                                        <div class="card-body">
                                        <h5 class="card-title"><?php echo $row['title']?></h5>
                                        <p class="card-text"><?=$row['subtitle']?></p>
                                        <a href="post.php?id=<?=$row['id']?>" class="btn btn-primary">اقرأ</a>
                                        </div>
                                    </div>-->
                    ...
                    <!--Boostrap div card
                     <div class="card" style="width: 18rem;">
                        <img class="card-img-top" src="assets\img\pdmisc1-16-nap.jpg" alt="Card image cap">
                        <div class="card-body">
                          <h5 class="card-title">مقالة</h5>
                          <p class="card-text">المقالة الاولى في منصة الأنامل </p>
                          <a href="post.html" class="btn btn-primary">اقرأ</a>
                        </div>
                      </div>-->
                    ...
                    <!-- Post preview
                            <div class="post-preview">
                                <img src="assets\img\pdmisc1-16-nap.jpg" class="img-fluid" alt="Responsive image">
                                <a href="post.php">
                                    <h2 class="post-title">"صندوق الرمل"</h2>
                                    <h3 class="post-subtitle">رواية "صندوق الرمل".. ليبيا التي تحترق</h3>
                                </a>
                                <p class="post-meta">
                                    <a href="#!">مبارك الكوشي</a>
                                      on September 24, 2022
                    ...
                    <!-- Pager-->
                    <div class="d-flex justify-content-end mb-4"><a class="btn btn-primary text-uppercase" href="allposts.php">كل المقالات</a></div>
                </div>
            </div>
        </div>
        <!-- Footer-->
