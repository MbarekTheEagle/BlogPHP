       ...
       <nav class="navbar navbar-expand-lg navbar-light" id="mainNav">
                ...
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        <div class="page-heading">
                            <h1 style="font-family: shareb;">حول الأنامل</h1>
                            <span class="subheading" style="font-family: shareb;">هذا ما نفعل    .</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <main class="mb-4">
            <div class="container px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        <p>مدونة الأنامل تعتبر منبرًا مفتوحًا لكل القراء والكتاب للتعبير عن آرائهم وافكارهم بشكل حرّ ومستقل. تهدف المدونة إلى توفير فضاء إلكتروني يشجع على الحوار وتبادل الأفكار في مجموعة متنوعة من المواضيع، بما في ذلك القضايا الاجتماعية، الثقافية، الفنية، العلمية، وغيرها. يمكن للمشاركين في المدونة نشر مقالاتهم، وتجاربهم الشخصية، ومشاركة آرائهم حول القضايا المهمة التي تهمهم  .</p>
                        <p>تُعَد مدونة الأنامل مكانًا يجمع بين مختلف الأصوات والآراء، وتشجع على التفاعل والتبادل الثقافي والفكري بين أفراد المجتمع. يُشجّع المشاركون على استخدام المدونة كمنصة للتعبير الحر، مع الالتزام بقواعد الاحترام والتسامح في التعامل مع آراء الآخرين  .</p>
                        <p>بفضل تنوع المواضيع والآراء المطروحة في مدونة الأنامل، يمكن للقراء الاستفادة من محتوى متنوع ومثير للاهتمام، والمشاركة في النقاشات وتبادل الخبرات والمعرفة مع مجتمع واسع عبر الإنترنت  .</p>
                    </div>
                </div>
            </div>
        </main>
